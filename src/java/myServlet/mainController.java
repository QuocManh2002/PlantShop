    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(action == null|| action.equals("")||action.equals("search"))
                ...
                url = "changeStatusOrderServlet";
            else if(action.equals("Search by ID"))
                url ="searchByIDServlet";
            else if(action.equals("Create new Plant"))
                url = "createNewPlant.jsp";
            else if(action.equals("Update Plant"))
                url = "updatePlant.jsp";
            else if(action.equals("UpdatePlant"))
                url = "updatePlantssServlet";
            else if(action.equals("UpdateCate"))
                url = "updateCatesServlet";
